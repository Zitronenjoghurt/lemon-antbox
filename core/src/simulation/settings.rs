...
pub struct AntSettings {
    ...
    pub pheromone_sense_threshold: f32,
    pub sensor_distance: f32,
    pub sensor_fov: f32,
    pub sensor_ray_count: u8,
    pub speed: f32,
    pub turn_angle: f32,
...
impl Default for AntSettings {
    fn default() -> Self {
        Self {
            ...
            pheromone_sense_threshold: 0.05,
            sensor_distance: 5.0,
            sensor_fov: std::f32::consts::PI,
            sensor_ray_count: 16,
            speed: 1.0,
            turn_angle: 0.2,
            wobble_strength: 0.4,
...
impl Default for SimulationSettings {
    fn default() -> Self {
        Self {
            ...
            pheromone_diffusion: 0.9,
            nest_pheromone_strength: 0.5,
